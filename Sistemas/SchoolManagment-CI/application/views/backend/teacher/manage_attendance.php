...
<div class="row" id="attendance_list">
    <div class="col-sm-offset-3 col-md-6">
        <table class="table table-bordered table-hover table-striped">
            <thead>
                <tr>
                    <td><?php echo ('Dia de matricula');?></td>
                ...
                <?php 
                    $students   =   $this->db->get_where('student' , array('class_id'=>$class_id))->result_array();
                        ...
                        <tr class="gradeA">
                            ...
                            <td style="text-transform:uppercase;"><?php echo date("d M Y", $row['diamatricula']);?></td>
                            <td style="text-transform:uppercase;"><?php echo $row['name']; echo '  '; echo $row['lastname'];?></td>
                            <?php 
    ...
    action="<?php echo base_url();?>index.php?teacher/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id;?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered table-hover table-striped">
                <thead>
                    <tr class="gradeA">
                        <th><?php echo ('Dia de matricula');?></th>
