...
<!--                            </div>-->
                            <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info"><?php echo ('Actualizar cuenta');?></button>
                              </div>
								</div>
                        </form>
						<?php
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="list" style="padding: 5px">
                <div class="box-content padded">
                    ...
                    foreach($edit_data as $row):
                        ?>
                        <?php echo form_open('index.php?teacher/manage_profile/change_password' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Confirmar nueva contreseña');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" name="" class="btn btn-info"><?php echo ('Actualizar perfil');?></button>
                              </div>
								</div>
                        </form>
						<?php
