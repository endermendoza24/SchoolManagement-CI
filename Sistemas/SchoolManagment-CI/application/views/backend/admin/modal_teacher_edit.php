		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                    <?php echo form_open(base_url() . 'index.php?admin/teacher/do_update/'.$row['teacher_id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Fecha Nacimiento');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="sex" class="form-control">
                                    	<option value="Femenino" <?php if($row['sex'] == 'Femenino')echo 'selected';?>><?php echo ('Femenino');?></option>
                                    	<option value="Masculino" <?php if($row['sex'] == 'Masculino')echo 'selected';?>><?php echo ('Masculino');?></option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Direccion');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="address" value="<?php echo $row['address'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Numero Telefonico');?></label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Contraseña(Temporal)');?></label>
                                <div class="col-sm-5">
