			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/'.$row['class_id'].'/do_update/'.$row['student_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
							...
							<select  name="parent_id" class="form-control" >  <!-- data-validate="required" data-message-required="<?php echo ('Value Required');?>" -->
                              ...
                              <?php 
									...
									foreach($parents as $row3):
										?>
                                		<option style="text-transform:uppercase;" value="<?php echo $row3['parent_id'];?>"
					...
					<div class="form-group">
						...
						<!--Nivel-->
							<div class="form-group">
							<label for="field-2" class="col-sm-3 control-label"><?php echo ('Nivel CEFR');?></label>
			                    <div class="col-sm-5">
			                        <select data-validate="required" data-message-required="<?php echo ('Value Required');?>" name="level" class="form-control">
			                            <optgroup label="NIvel actual">
			                                <option value=""><?php echo $row['level'];?></option>
			                            </optgroup>
			                            <optgroup label="Principiantes">
			                                <option value="A1-">A1-</option>
			                                <option value="A1+">A1+</option>
			                                <option value="A2-">A2-</option>
			                                <option value="A2+">A2+</option>
			                            </optgroup>
			                            <optgroup label="Intermedios">
