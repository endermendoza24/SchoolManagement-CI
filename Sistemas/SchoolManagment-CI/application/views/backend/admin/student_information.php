                ...
                <table class="table table-bordered datatable table-hover table-striped" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>                            
                            ...
                            <td style="text-transform:uppercase;"><?php echo $row['name'];?>  <?php echo $row['lastname'];?></td>
                            <td style="text-transform:uppercase;"><?php echo $row['address'];?></td>
                            <td><?php echo $row['email'];?></td>
                            <td style="text-transform:uppercase;"><?php echo  $row['nombreemergencia'] . ' ' . ' ' . $row['apellidoemergencia'] ;?></td>
                            <td>
