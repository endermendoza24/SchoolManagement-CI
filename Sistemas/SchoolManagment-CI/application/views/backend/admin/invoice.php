                ...
                <table  class="table table-bordered table-hover table-striped datatable"  id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-transform:uppercase;"><?php echo $row['quienpaga'];?></td>
                            ...
                            <td style="text-transform:uppercase;"><?php echo $row['payment_details'];?></td>
							...
							<td style="text-transform:uppercase;"><?php echo date('d M Y, h:i a',$row['creation_timestamp']);?></td>
							<td>
                            <div class="btn-group">
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="col-sm-9">
                                        <select onchange="if(this.value == 2) document.getElementById('baucher').disabled = false" name="metodo" id="metodo" class="form-control">
                                            ...
                                            <option value="2"><?php echo ('Transferencia');?></option> 
                                             <option value="3"><?php echo ('Pago pendiente');?></option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label style="text-transform:uppercase; color:#000; font-weight:bold" class="col-sm-3 control-label"><?php echo ('* Fecha de pago*');?></label>
                                    <div class="col-sm-9">
...
<script type="text/javascript">
        ...
        var pendiente = "<option value='Pendiente'>Pago pendiente</option>"
        ...
        if(idMotel == "Mensualidad")
            ...
            else if(idMotel =="pendiente")
            $("#Habitacion").html(pendiente);  
