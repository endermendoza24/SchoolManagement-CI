            ...
            <div class="tab-pane active" id="home">
                ...
                <table class="table table-bordered table-hover table-striped datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="text-transform:uppercase"><?php echo strftime('%A, %d de %B de %Y', $row['diamatricula']);?></td>
                            <!-- <td align="center"><img src="<?php echo $this->crud_model->get_image_url('student',$row['student_id']);?>" class="img-circle" width="30" /></td> -->
                            <td style="text-transform:uppercase"><?php echo $row['name'] . ' ' . $row['lastname'];?></td>
                            <td>
