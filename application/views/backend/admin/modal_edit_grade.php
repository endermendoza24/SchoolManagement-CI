	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="padded">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo ('Pubtos de la escala');?></label>
                    <div class="col-sm-5 controls">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo ('Editar escala');?></button>
						</div>
					</div>
                </form>
            </div>
