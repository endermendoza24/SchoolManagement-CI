                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/transport/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" require class="form-control" name="route_name"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo ('Number of vehicle');?></label>
                                <div class="col-sm-5">
                                    <input type="text"  require class="form-control" name="number_of_vehicle"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" require class="form-control" name="route_fare"/>
                                </div>
                            </div>
                        <div class="form-group">
