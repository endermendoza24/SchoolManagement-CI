		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo ('Editar categoria de gastos');?>
            	</div>
            </div>
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/expense_category/edit/' . $row['expense_category_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="name" data-validate="required" data-message-required="<?php echo ('Valor Requerido');?>" value="<?php echo $row['name'];?>">
						</div>
					</div>
